...
This project demonstrates the transition from "Busy-Wait" programming to Event-Driven Architecture on the ATSAMD21E18A. We utilize the hardware timers and interrupts so that the system can achieve precise timing without blocking the main execution loop.
### Technical Features
...
This project was co-developed by Jessica Ly and Daniel Meija Mendez. We worked together on the manual clock configuration and the interrupt vector table setup.
